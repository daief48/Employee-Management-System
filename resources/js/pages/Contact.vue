    ...
    <section id="contact-us">
        ...
        <div class="container">
            ...
            <div class="contact-form">
                <form action="" method="">
                    <!-- Name -->
                    <label for="name"><span class="text-white">Name</span></label>
                    <input type="text" id="name" name="name" value="" />

                    <!-- Email -->
                    <label for="email"><span class="text-white">Email</span></label>
                    <input type="text" id="email" name="email" value="" />

                    <!-- Subject -->
                    <label for="subject"><span class="text-white">Subject</span></label>
                    <input type="text" id="Subject" name="subject" value="" />

                    <!-- Message -->
                    <label for="message"><span class="text-white">Message</span></label>
